...
class atmCorrection:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Atmospheric correction')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'atmCorrection')
        self.toolbar.setObjectName(u'atmCorrection')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('atmCorrection', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/atmCorrection/icon.png'
        self.add_action(
            icon_path,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Atmospheric correction'),
                action)
